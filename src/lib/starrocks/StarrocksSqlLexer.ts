// Generated from dt-sql-parser/src/grammar/starrocks/StarrocksSqlLexer.g4 by ANTLR 4.13.1
...
export class StarrocksSqlLexer extends antlr.Lexer {
    ...
    public constructor(input: antlr.CharStream) {
        super(input);
        this.interpreter = new antlr.LexerATNSimulator(this, StarrocksSqlLexer._ATN, StarrocksSqlLexer.decisionsToDFA, new antlr.PredictionContextCache());
    }

    public get grammarFileName(): string { return "StarrocksSqlLexer.g4"; }

    public get literalNames(): (string | null)[] { return StarrocksSqlLexer.literalNames; }
    public get symbolicNames(): (string | null)[] { return StarrocksSqlLexer.symbolicNames; }
    public get ruleNames(): string[] { return StarrocksSqlLexer.ruleNames; }

    public get serializedATN(): number[] { return StarrocksSqlLexer._serializedATN; }
    ...
    public static get _ATN(): antlr.ATN {
        if (!StarrocksSqlLexer.__ATN) {
            StarrocksSqlLexer.__ATN = new antlr.ATNDeserializer().deserialize(StarrocksSqlLexer._serializedATN);
        }
    ...
    private static readonly vocabulary = new antlr.Vocabulary(StarrocksSqlLexer.literalNames, StarrocksSqlLexer.symbolicNames, []);

    public override get vocabulary(): antlr.Vocabulary {
        return StarrocksSqlLexer.vocabulary;
    }

    private static readonly decisionsToDFA = StarrocksSqlLexer._ATN.decisionToState.map( (ds: antlr.DecisionState, index: number) => new antlr.DFA(ds, index) );
}