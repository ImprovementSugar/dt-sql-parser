...
import type { StarrocksSqlParserListener } from '../../lib/starrocks/StarrocksSqlParserListener';
import { EntityContextType } from '../common/types';
import { StmtContextType, EntityCollector } from '../common/entityCollector';

export class SparkEntityCollector extends EntityCollector implements StarrocksSqlParserListener {
    /** ====== Entity Begin */
